	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (act==null) {
			...
			try {
				...
				request.setAttribute("month", listToEdit.getLastUpdated().getMonthValue());
				request.setAttribute("date", listToEdit.getLastUpdated().getDayOfMonth());
				request.setAttribute("year", listToEdit.getLastUpdated().getYear());
				
				ShoeItemHelper daoForItems = new ShoeItemHelper();
